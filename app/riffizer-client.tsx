...
function IdeaCard({ part, isPlaying, active, activeTime, activeStep, selectedChord, harmonyEnabled, onToggleHarmony, onPlay, onStep, onRemove, onAuditionChord, onTempoChange }: { part: Part; isPlaying: boolean; active: number | null; activeTime: number | null; activeStep: ActiveStep | null; selectedChord: SelectedChord | null; harmonyEnabled: boolean; onToggleHarmony: () => void; onPlay: () => void; onStep: (direction: number) => void; onRemove?: () => void; onAuditionChord: (bar: number) => void; onTempoChange: (tempo: number) => void }) {
